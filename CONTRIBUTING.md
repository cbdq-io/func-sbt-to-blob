...
1. Clone your fork (using either HTTPS or SSH):
   ...
   ```shell
   # If using HTTPS:
   git clone https://github.com/YOUR_USERNAME/func-sbt-to-blob.git

   # If using SSH:
   git clone git@github.com:YOUR_USERNAME/func-sbt-to-blob.git
...
1. Setup the Upstream Repository
   ...
   # If using HTTP
   git remote add upstream https://github.com/cbdq-io/func-sbt-to-blob.git


   # If using SSH
   git remote add upstream git@github.com:cbdq-io/func-sbt-to-blob.git
